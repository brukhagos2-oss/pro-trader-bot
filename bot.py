...
# Gold API Configuration (Using your provided key)
GOLD_API_KEY = "goldapi-0e62024fc9c1fc4b2509182ce59fff57-io"
...
# ==========================================
# OFFICIAL GOLDAPI.IO PRICE FETCHER
# ==========================================
def fetch_gold_price():
    """
    Fetches real-time Gold spot price using goldapi.io with your key.
    """
    headers = {
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"GoldAPI returned status code {response.status_code}: {response.text}")
    except Exception as e:
        print(f"Error fetching Gold price via goldapi.io: {e}")
    return None
...
def analyze_gold_market():
    ...
    detail = "Official GoldAPI.io Live Price Action Confluence"
...
def background_signal_and_result_worker():
    ...
    """
    print("🚀 Gold (XAU/USD) Dedicated 1:3 Profit Engine Initialized with GoldAPI.io...")
    ...
    while True:
        try:
            for display_name, symbol in ASSETS.items():
                ...
                price, action, risk, detail = analyze_gold_market()
...
if __name__ == '__main__':
    ...
    print("Gold Dedicated Telegram Bot engine initialized successfully with GoldAPI.io...")
