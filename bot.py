...
# ============================================================
# CONFIG (Binance PAXG Configuration)
# ============================================================
...
# Binance Spot API for PAXG/USDT (Free & No API Key needed)
...
# ============================================================
# BINANCE API (Instead of GoldAPI)
# ============================================================
...
def get_gold_price():
    ...
    try:
        ...
        if price is None:
            print("Binance response has no price.")
            return None
...
def signal_message(signal):
    ...
    return (
        ...
        "⚠️ *PAXG/USDT (Gold) • 5-minute scalping*"
    )
...
def market_engine():
    ...
    print(
        " PAXG/USD 5-MINUTE SCALPER (Binance)"
    )
...
def start_command(message):
    ...
    bot.send_message(
        ...
        (
            "🤖 *PAXG/USDT 5M Scalper*\n\n"
            "🥇 Asset: PAXG/USDT (Gold on Binance)\n"
            "⏱ Timeframe: 5 minutes\n"
            "📊 EMA + RSI + ATR\n"
            "🎯 Risk/Reward: 1:3\n\n"
